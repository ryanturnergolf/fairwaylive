      ...
      <header className="hidden">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-8">
          ...
          <nav className="hidden items-center gap-5 text-[11px] font-semibold uppercase tracking-[0.25em] text-[#0B3D2E]/75 md:flex">
            ...
            <Link className="transition duration-200 hover:text-[#B8892D]" href="/coach-dashboard/players">
              Players
            </Link>
            <Link className="transition duration-200 hover:text-[#B8892D]" href="/coach-dashboard/team-performance">
              Team Performance
            </Link>
            <Link className="transition duration-200 hover:text-[#B8892D]" href="/coach-dashboard/team-statistics">
              Team Statistics
            </Link>
